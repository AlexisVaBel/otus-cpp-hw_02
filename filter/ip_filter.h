...
void applyable_filter_printImproved( bool (*f)(const IpVectorT& elm ), int (*g)(const IpVectorsT &ips_vct) ,IpVectorsT ip_vct [[gnu::unused]]){
...
void applyable_filter_print( bool (*f)(const IpVectorT& elm),IpVectorsT ip_vct){
    for ( auto n : ip_vct ) {
...
auto applyable_filter( bool (*f)(const IpVectorT& elm),IpVectorsT ip_vct){
...
bool f_byFirst_One(const IpVectorT& elm){
...
bool f_byFirst46_Second70(const IpVectorT& elm){
...
bool f_byAny46(const IpVectorT& elm){
    for(auto str: elm){
